<div class="flex flex-col max-w-sm space-y-6">
        ...
        <div wire:poll.visible>
            ...
            @if ($product && !is_array($this->product) && $product->cover_image)
                <div class="mt-2 relative">
                    <button wire:click="deleteImage({{ $product }})" class="absolute bg-red-500 right-0 p-2">
    ...
    @foreach ($stocks as $key => $stock)
        <div class="grid grid-cols-2 gap-6" wire:key="stock-{{ $key }}">
            <div>
                ...
                <select
                    ...
                    wire:model.defer="stocks.{{ $key }}.size">
