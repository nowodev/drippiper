        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Winter-Summer Hoodie</h1>
                    <div class="flex mb-4">
                    ...
                    <p class="leading-relaxed">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam nobis aperiam repudiandae
                        tenetur laborum tempora officia aliquid optio enim quo, cupiditate recusandae non illum dolor
                        accusamus nulla voluptatum quasi est eligendi fugiat eum atque! Rerum?
                    </p>
