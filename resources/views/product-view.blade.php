        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Brand Description
                    </h1>
                    <div class="flex mb-4">
                    ...
                    <p class="leading-relaxed">
                        ...
                        necessitatibus eligendi obcaecati
                        numquam mollitia consequuntur similique sit, accusantium quaerat
                        perspiciatis recusandae praesentium
                        rem explicabo fuga vero temporibus laudantium? Sequi quos accusantium
                        necessitatibus. Neque, quia
                        sapiente?
                    </p>
